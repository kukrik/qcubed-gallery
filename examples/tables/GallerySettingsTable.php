...
class GallerySettingsTable extends \QCubed\Plugin\Control\VauuTable
{
	...
	public function createColumns() 
	{
		...
		$this->colPostUpdateDate = $this->createNodeColumn(t("Updated"), QQN::CategoryOfNews()->PostUpdateDate);
